...
public class FormattedTextMetricsTest {
    ...
    @Test
    public void computeLineBreakKeepsFormattingPrefix() {
    ...
    @Test
    public void computeLineBreakPrefersSpaceAfterFormatting() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        widthFunction.setWidth(' ', 4.0f);
        String text = "\u00A7lHello \u00A7oworld";

        int expected = vanillaSizeStringToWidth(text, 34, widthFunction);
        int actual = FormattedTextMetrics.computeLineBreakIndex(text, 34, false, widthFunction, 0.0f, 1.0f);

        assertEquals(expected, actual);
    }

    @Test
    public void computeLineBreakHandlesRgbPrefix() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        widthFunction.setWidth(' ', 4.0f);
        String text = "<123456>Hello world";

        int breakIndex = FormattedTextMetrics.computeLineBreakIndex(text, 30, false, widthFunction, 0.0f, 1.0f);

        assertEquals(13, breakIndex);
    }

    @Test
    public void computeLineBreakHandlesAmpersandRgbPrefix() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        widthFunction.setWidth(' ', 4.0f);
        String text = "&123456Hello world";
    ...
    @Test
    public void computeLineBreakTreatsFormattingAsVisibleInRawMode() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        int breakIndex = FormattedTextMetrics.computeLineBreakIndex("&lAB", 6, true, widthFunction, 0.0f, 1.0f);
    ...
    @Test
    public void calculateWidthResetsBoldAfterRgbPush() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
    ...
    @Test
    public void calculateWidthHonoursNewlines() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        float width = FormattedTextMetrics.calculateMaxLineWidth("AB\nCDE", false, widthFunction, 0.0f, 1.0f);

        assertEquals(15.0f, width, 0.0001f);
    }
