...
public class FormattedTextMetricsTest {
    ...
    @Test
    public void computeLineBreakKeepsLeadingFormattingWhenGlyphDoesNotFit() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        String text = "\u00A7lHello";
        int breakIndex = FormattedTextMetrics.computeLineBreakIndex(text, 2, false, widthFunction, 0.0f, 1.0f);
        assertEquals(2, breakIndex);
    }

    @Test
    public void computeLineBreakMatchesVanillaWithStackedFormatting() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        widthFunction.setWidth(' ', 4.0f);
        String text = "\u00A7l\u00A7oBold words wrap here";
        int maxWidth = 36;
    ...
    @Test
    public void computeLineBreakTreatsAmpersandFormattingLikeVanilla() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        widthFunction.setWidth(' ', 4.0f);
        String text = "&lBold words wrap";
        int maxWidth = 25;

        int expected = vanillaSizeStringToWidth("\u00A7lBold words wrap", maxWidth, widthFunction);
        int actual = FormattedTextMetrics.computeLineBreakIndex(text, maxWidth, false, widthFunction, 0.0f, 1.0f);
    ...
    @Test
    public void computeLineBreakIgnoresAmpersandsInRawMode() {
        SimpleCharWidthFunction widthFunction = new SimpleCharWidthFunction(5.0f);
        widthFunction.setWidth(' ', 4.0f);
        String text = "&lBold words";
        int breakIndex = FormattedTextMetrics.computeLineBreakIndex(text, 20, true, widthFunction, 0.0f, 1.0f);
